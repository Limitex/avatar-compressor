...
- **Runtime-generated texture skipping** - Textures without asset paths are now automatically skipped
  - Prevents compression of data textures generated by tools like VRCFury SPS during build
  - These textures often use RGB values for calculations (depth data, deformation vectors) rather than visual color
