...
{
    [TestFixture]
    internal class TextureFormatSelectorTests
    {
        ...
        #region ResolvePlatform Tests

        [Test]
        public void ResolvePlatform_Desktop_ReturnsDesktop()
        {
            var result = TextureFormatSelector.ResolvePlatform(CompressionPlatform.Desktop);

            Assert.AreEqual(CompressionPlatform.Desktop, result);
        }

        [Test]
        public void ResolvePlatform_Mobile_ReturnsMobile()
        {
            var result = TextureFormatSelector.ResolvePlatform(CompressionPlatform.Mobile);

            Assert.AreEqual(CompressionPlatform.Mobile, result);
        }

        [Test]
        public void ResolvePlatform_Auto_ReturnsNonAuto()
        {
            var result = TextureFormatSelector.ResolvePlatform(CompressionPlatform.Auto);

            Assert.That(
                result,
                Is.EqualTo(CompressionPlatform.Desktop).Or.EqualTo(CompressionPlatform.Mobile)
            );
        }
