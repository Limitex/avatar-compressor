...
namespace dev.limitex.avatar.compressor.tests
{
    ...
    public class CustomCompressorPresetTests
    {
        ...
        #region Custom Edit Mode Tests

        [Test]
        public void IsInCustomEditMode_DefaultIsFalse()
        {
            Assert.That(_config.IsInCustomEditMode, Is.False);
        }

        [Test]
        public void ApplyCustomPreset_SetsPresetToCustom()
        {
            _config.Preset = CompressorPreset.Balanced;

            _config.ApplyCustomPreset(_preset);

            Assert.That(_config.Preset, Is.EqualTo(CompressorPreset.Custom));
        }

        [Test]
        public void ApplyCustomPreset_AssignsPresetAsset()
        {
            _config.CustomPresetAsset = null;
        ...
        [Test]
        public void ApplyCustomPreset_ExitsEditMode()
        {
            _config.IsInCustomEditMode = true;
        ...
        [Test]
        public void ApplyCustomPreset_AppliesPresetSettings()
        {
            _preset.MaxDivisor = 12;
            _preset.Strategy = AnalysisStrategyType.Fast;
        ...
        [Test]
        public void SwitchToCustomEditMode_SetsPresetToCustom()
        {
            _config.Preset = CompressorPreset.Balanced;

            _config.SwitchToCustomEditMode();

            Assert.That(_config.Preset, Is.EqualTo(CompressorPreset.Custom));
        }

        [Test]
        public void SwitchToCustomEditMode_SetsEditModeTrue()
        {
            _config.IsInCustomEditMode = false;

            _config.SwitchToCustomEditMode();

            Assert.That(_config.IsInCustomEditMode, Is.True);
        }

        [Test]
        public void SwitchToCustomEditMode_PreservesCustomPresetAsset()
        {
            _config.CustomPresetAsset = _preset;
            _config.IsInCustomEditMode = false;
        ...
        [Test]
        public void ApplyCustomPreset_WithNull_DoesNotChangeState()
        {
            _config.Preset = CompressorPreset.Balanced;
            _config.IsInCustomEditMode = true;

            _config.ApplyCustomPreset(null);
        ...
        public void IsInUseOnlyMode_TrueWhenPresetAssignedAndNotEditing()
        {
            ...
            Assert.That(_config.IsInUseOnlyMode, Is.True);
        }
        ...
        public void IsInUseOnlyMode_FalseWhenNoPresetAssigned()
        {
            ...
            Assert.That(_config.IsInUseOnlyMode, Is.False);
        }
        ...
        [Test]
        public void ApplyPreset_PreservesIsInCustomEditMode()
        {
            _config.IsInCustomEditMode = true;
        ...
        [Test]
        public void ApplyPreset_ToCustom_PreservesIsInCustomEditMode()
        {
            _config.IsInCustomEditMode = true;
