...
namespace dev.limitex.avatar.compressor.editor.texture.ui
{
    ...
    public static class PresetColors
    {
        ...
        public static readonly Color Standard = new Color(0.3f, 0.6f, 0.9f);
        public static readonly Color Balanced = new Color(0.9f, 0.7f, 0.2f);
        public static readonly Color Aggressive = new Color(0.9f, 0.3f, 0.3f);
