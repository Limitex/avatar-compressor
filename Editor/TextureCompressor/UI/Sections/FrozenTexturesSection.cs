...
namespace dev.limitex.avatar.compressor.texture.ui
{
    ...
    public static class FrozenTexturesSection
    {
        ...
        /// </summary>
        public static void Draw(TextureCompressor config, SearchBoxControl search, ref bool showSection, ref Vector2 scrollPos)
        {
            ...
            if (frozenCount == 0)
            {
                EditorGUILayout.HelpBox("No frozen textures. Click 'Freeze' on textures in Preview to add manual overrides.", MessageType.Info);
                return;
            }
        ...
        private static void DrawFrozenTextureEntry(TextureCompressor config, FrozenTextureSettings frozen, int index)
        {
