...
- **Uncompressed on unknown property (see Data Protection)**: Texture is uncompressed and assigned to an unrecognized shader property, with **Skip uncompressed textures on unknown properties** enabled
