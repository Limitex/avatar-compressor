---
title: Quick Start
description: "How to install LAC: Avatar Compressor"
icon: Rocket
---
...
Download the latest `.zip` from the [GitHub Releases](https://github.com/Limitex/avatar-compressor/releases) page.
