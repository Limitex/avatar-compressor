...
<Accordion title="Can't edit the preset">
  The preset may be restricted: - **Locked**: Disable the Lock field on the
  preset asset - **Built-in**: These are read-only; click **Edit** then
  **Unlink** to copy settings - **External Package**: Same as built-in; unlink
  to edit locally
</Accordion>
